...
features:
  - title: Every agent has a role
    details: Give each profile its own identity, instructions, tools, and knowledge — a specialist on your team.
  - title: Your nakama, one deployment
    details: Run a whole team of agents from a single Nakama server with shared orgs, channels, and operations.
